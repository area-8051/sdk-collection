 ...
 * Version            : V1.0
 * Date               : 2020/08/06
 * Description        : SPI0 demonstrates Master/Slave mode data transmission and reception
